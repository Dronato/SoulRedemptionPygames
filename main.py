    ...
    def start_game(self, map_path):
        ...
        if map_path == "Mapa.tmx":
            ...
            try:
                ...
                inimigo10 = inimigo.Inimigo2mp2(x=2165, y=1118, jogador=self.jogador, colisao_rects=self.colisao_rects, tmx_data=self.tmx_data, largura_mapa=self.largura_mapa, altura_mapa=self.altura_mapa_real)
                inimigo11 = inimigo.Inimigo2mp2(x=2795, y=1189, jogador=self.jogador, colisao_rects=self.colisao_rects, tmx_data=self.tmx_data, largura_mapa=self.largura_mapa, altura_mapa=self.altura_mapa_real)        
                ...
                inimigo13 = inimigo.Inimigo2mp2(x=3390, y=1100, jogador=self.jogador, colisao_rects=self.colisao_rects, tmx_data=self.tmx_data, largura_mapa=self.largura_mapa, altura_mapa=self.altura_mapa_real)  
                ...
                inimigo17 = inimigo.Inimigo2mp2(x=2820, y=382, jogador=self.jogador, colisao_rects=self.colisao_rects, tmx_data=self.tmx_data, largura_mapa=self.largura_mapa, altura_mapa=self.altura_mapa_real)  
